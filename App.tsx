...
// ─── Tab icon component (no icon library needed) ──────────────────────────────
...
function ListsStack() {
  return (
    ...
    >
      ...
      <Stack.Screen name="TripDetail" component={TripDetailScreen} options={{ title: 'Grocery List', headerBackTitle: 'Lists' }} />
    </Stack.Navigator>
  );
}

// Home stack — Home → TripDetail (quick access from dashboard)
function HomeStack() {
  return (
    <Stack.Navigator
      screenOptions={{
    ...
    >
      ...
      <Stack.Screen name="TripDetail" component={TripDetailScreen} options={{ title: 'Grocery List', headerBackTitle: 'Home' }} />
    </Stack.Navigator>
  );
}
        ...
        <NavigationContainer>
          ...
          >
            ...
            <Tab.Screen
              ...
              options={{ tabBarIcon: ({ focused }) => <TabIcon label="Lists"    focused={focused} /> }}
            />
            <Tab.Screen
              name="ScannerTab"
